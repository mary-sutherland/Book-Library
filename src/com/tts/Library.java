...
public class Library {
    ...
    public void printAvailableBooks() {
        if(inventory.size() == 0) System.out.println("No books found in catalogue.");
    ...
    public void addBook(Book book) {
        if(inventory.contains(book)) {
            System.out.println("Library already contains " + book.getTitle() + ". Please choose another book.");
        } else {
            inventory.add(book);
        }
    }
